...
namespace TbspRpgDataLayer.Migrations
{
    ...
    [Migration("20260120011601_ScriptOrderedIncludes")]
    partial class ScriptOrderedIncludes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TbspRpgDataLayer.Entities.ScriptInclude", b =>
                {
            ...
            modelBuilder.Entity("TbspRpgDataLayer.Entities.ScriptInclude", b =>
                {
                    b.HasOne("TbspRpgDataLayer.Entities.Script", "IncludedIn")
                        .WithMany("Includes")
                        .HasForeignKey("IncludedInId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TbspRpgDataLayer.Entities.Script", "Includes")
                        .WithMany("IncludedIn")
